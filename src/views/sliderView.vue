  ...
  <div class="wrap">
    ...
    <div class="flex-col box">
      ...
      <div class="wrap">
        ...
        <div class="desc">2.<del>增加插槽：包括轮播图片插槽、箭头按钮插槽、组按钮插槽</del></div>
        <div class="desc">3.增加轮播图切换方式：无论中间隔几幅轮播图，切换时永远只显示切换一次的动画（跳过中间实际存在的轮播图，就像目标和当前选中是相邻的一样）</div>
        <div class="desc">4.<del>新增页面大小改变事件订阅，当页面大小改变时重新计算轮播图宽度</del></div>
        <div class="desc">5.<del>增加移动端触控适配</del>，检测为移动端时取消自动隐藏箭头/组按钮</div>
      </div>
    </div>
